...
const bodyStyle = {
  ...
  const formBoxStyle = {
    ...
    maxWidth: '50%',
    marginTop: '3rem', // Add margin for spacing
    marginRight: '2rem',
    marginLeft: '4.5rem',
    marginBottom: '6rem', // Add margin for spacing
    overflowY: 'auto',
...
const deleteButtonStyle = {
  background: '#415d94', // Blue theme color
  color: '#fff',
  border: 'none',
  marginLeft: '10px',
};
      ...
      <div style={scheduledMedicineBoxStyle}>
        ...
        <ul style={{ listStyle: 'none', padding: 0 }}>
          {medicineList.map((medicine, index) => (
            <li key={index} >
            <div>
              <li><strong>Medicine:</strong> {medicine.medicineName}</li>
              <li><strong>Dosage:</strong> {medicine.dosage}</li>
              <li><strong>Duration:</strong> {medicine.duration}</li>
              <li><strong>Recipient Number:</strong> {medicine.recipientNumber}</li>
            </div>
            <Button variant="danger" onClick={() => deleteMedicine(index)} style={deleteButtonStyle}>
              <IoTrash />
            </Button>
          </li>
